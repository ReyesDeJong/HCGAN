...
if __name__ == "__main__":
    ...
    train_features = tsfresh_extractor.get_tsfresh(x_train_real)
    val_features = tsfresh_extractor.get_tsfresh(x_val_real)
    test_features = tsfresh_extractor.get_tsfresh(x_test_real)

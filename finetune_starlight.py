...
RESULTS_NAME = 'finetune_loss_stop_lr%.1f_%sdp_%.1f_pt_%i_%s' % (LR_VAL_MULT,
...
if __name__ == '__main__':
    ...
    for run_idx in result_dict_for_different_versions_runs.keys():
        ...
        for version_idx, keep_sample in enumerate(keep_samples_list):
            ...
            best_gan_for_percentage = versions_to_get[version_idx]#np.random.randint(0, len(versions))]

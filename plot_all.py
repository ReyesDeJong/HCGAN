...
def plot_metric(results_list, set_to_plot, metric_to_plot, x_axis_name, y_axis_name, fig_size=8, plot_label=''):
    ...
    plt.title('Accuracy as a function of unbalance (%% least populated classes kept in %s set)' % set_to_plot)
...
dicts_trtr = np.load(os.path.join(PATH_TO_PROJECT, 'results', 'same_set', 'trts_same_all_v2_v3_v4_v5_v6_v7_v9_v10.pkl'))

...
results_trtr = get_results_from_path(
    os.path.join(
        PATH_TO_PROJECT, 'results_old', 'same_set',
        'trts_amp_balanced_v2_v3_v4_v5_v6_v7_v8_v9.pkl')
)

results_trtr_bn = get_results_from_path(
    os.path.join(
        PATH_TO_PROJECT, 'results_old', 'same_set',
        'trts_augmented_amp_balanced_v2_v3_v4_v5_v6_v7_v8_v9.pkl')
)
...
plot_metric([results_trtr, results_trtr_bn], set_to_plot, [metric_to_plot_trtr, metric_to_plot_trtr],

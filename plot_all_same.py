...
dicts_trtr_aug_50_50 = np.load(os.path.join(PATH_TO_PROJECT, 'results_old', 'same_set', 'trts__augmented_amp_balanced_larger_train_50-50v2_v3_v4_v5.pkl'))
...
plot_metric([results_trtr, results_trtr_aug, results_trtr_aug_50_50], set_to_plot, [metric_to_plot_trtr, metric_to_plot_trtr, metric_to_plot_trtr],
            '% of least populated classes kept', 'Accuracy', plot_label=['TRTR', 'Augmented_50-50', 'Augmented_50-50_old'])

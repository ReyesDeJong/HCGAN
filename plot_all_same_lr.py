...
results_fine_tune_same = get_results_from_path(
    os.path.join(
        PATH_TO_PROJECT, 'results', 'fine_tune',
        'random_gan_resultsfinetune_SAME_lr_batch_norm_dp_0.5_pt_20_starlight_noisy_irregular_all_same_set_amp_balanced_larger_trainv2_v3_v4_v5_v6_v7_v8_v9.pkl')
)
...
results_fine_tune_1 = get_results_from_path(
    os.path.join(
        PATH_TO_PROJECT, 'results', 'fine_tune',
        'single_gan_resultsfinetune_loss_stop_lr1.0_batch_norm_dp_0.5_pt_20_starlight_noisy_irregular_all_same_set_amp_balanced_larger_trainv2_v3_v4_v5_v6_v7_v8_v9.pkl')
)

results_fine_tune_03 = get_results_from_path(
    os.path.join(
        PATH_TO_PROJECT, 'results', 'fine_tune',
        'single_gan_resultsfinetune_loss_stop_lr0.3_batch_norm_dp_0.5_pt_20_starlight_noisy_irregular_all_same_set_amp_balanced_larger_trainv2_v3_v4_v5_v6_v7_v8_v9.pkl')
)

results_fine_tune_01 = get_results_from_path(
    os.path.join(
        PATH_TO_PROJECT, 'results', 'fine_tune',

...
BASE_GEN_DATA_FOLDER_NAME = 'catalina_amp_irregular_9classes'
...
def main(result_dict={}, catalina_n_classes=1):
    ...
    checkpoint = ModelCheckpoint('TSTR_' + date + '/train/' + real_data_folder + '/weights.best.trainonreal.hdf5',
    ...
    model = load_model('TSTR_' + date + '/train/' + real_data_folder + '/weights.best.trainonreal.hdf5')

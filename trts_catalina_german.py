...
date = '1803'
in_TSTR_FOLDER = 'datasets_original/REAL/'#'augmented/'
file_to_save_name = 'trts_v2'
...
if __name__ == '__main__':
    ...
    class_start = 3
    class_end = 9
    class_list = np.arange(class_start, class_end + 1)
    for class_n in class_list:
        main(dict_1, class_n)
    print(dict_1)
    pname = os.path.join(os.getcwd(), '%s.pkl'%file_to_save_name)#_augmented_90k.pkl')

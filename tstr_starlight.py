...
def main(result_dict={}, PERCENTAGE_OF_SAMPLES_TO_KEEP_FOR_DISBALANCE=1.0):
    folder = 'starlight_amp_noisy_irregular_all_%.2f' % PERCENTAGE_OF_SAMPLES_TO_KEEP_FOR_DISBALANCE
    dataset_real = 'starlight_noisy_irregular_all_%.2f' % PERCENTAGE_OF_SAMPLES_TO_KEEP_FOR_DISBALANCE
    ...
    if os.path.isfile('TSTR_' + date + '/train/' + folder + '/trainonsynthetic_model.h5'):
        ...
        earlyStopping = EarlyStopping(monitor='val_loss', min_delta=0.00000001, patience=10, verbose=1,
                                      mode='min')  # 0.00000001   patience 0
